...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '0905e7a5492b4a979c8abcc5bd6c5eda',
  THEME: process.env.NEXT_PUBLIC_THEME || 'magazine', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tianyao Xiao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '酒红色.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xty27.top', // 网站地址
